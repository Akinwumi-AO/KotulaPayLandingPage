      ...
      <main className="relative overflow-hidden pt-32 pb-24">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <Shield className="mx-auto mb-6 size-24 text-[#c5e063]" />
            <h1 className="mb-6 text-5xl font-bold text-white md:text-6xl">
              Privacy Policy
            </h1>
            <p className="mx-auto max-w-2xl text-xl text-gray-400 leading-relaxed">
              Your privacy and data security are our top priorities. We're preparing a comprehensive 
              privacy policy that outlines how we collect, use, protect, and manage your information 
          ...
          >
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
              <p className="text-gray-300">
                Our detailed privacy policy will be available soon. We're committed to transparency 
