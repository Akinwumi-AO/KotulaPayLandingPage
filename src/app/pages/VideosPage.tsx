...
import { Construction, Play, Bell } from 'lucide-react';
        ...
        <div className="relative z-10 mx-auto max-w-[1920px] px-6 md:px-12 lg:px-[192px]">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#289685]/40 bg-[#289685]/10 px-4 py-2">
              <Play className="size-4 fill-[#289685] text-[#289685]" />
              <span className="text-sm font-medium text-[#289685]">Video Resources</span>
            </div>
            ...
            <p className="text-lg text-[#cdced7] leading-relaxed md:text-xl">
              Tutorials, product demos, webinars, and customer success stories to help you
              get the most out of Kotulapay's payment infrastructure.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="rounded-3xl bg-white px-8 py-12 text-center">
              ...
              <p className="mb-8 text-[#62636c] leading-relaxed">
                Our video library is currently in development. Soon you'll be able to access
                comprehensive tutorials, integration guides, and expert interviews — all in one place.
              </p>
        ...
        <div className="mx-auto max-w-[1920px] px-6 md:px-12 lg:px-[192px]">
          <div className="relative overflow-hidden rounded-3xl bg-[#001c26] px-8 py-16 text-center md:px-16">
            ...
            <div className="relative z-10">
              <div className="mx-auto mb-4 flex size-[52px] items-center justify-center rounded-[14px] bg-[#289685]/20">
                <Bell className="size-6 text-[#289685]" />
              </div>
              ...
              <p className="mx-auto mb-8 max-w-[520px] text-lg text-[#cdced7] leading-relaxed">
                In the meantime, explore our documentation or reach out to our team directly.
              </p>
