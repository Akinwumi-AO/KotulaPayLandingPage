...
export default function Group1() {
  return (
    <div className="relative size-full">
      <p className="absolute font-['Circular_Std:Medium',sans-serif] leading-[normal] left-[34.13px] not-italic text-[#001c26] text-[49.683px] top-[17.45px] tracking-[-2.981px]">Kotulapay</p>
      <Group />
    </div>
  );
}