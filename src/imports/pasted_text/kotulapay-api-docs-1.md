...
curl "https://business.kotulapay.com/api/v1/payments?dateFrom=2016-05-11&page=1&perPage=1" \
    -H "Authorization: Bearer merchant_private_key"
Return status 200 and JSON:
Copy
...
curl "https://business.kotulapay.com/api/v1/payments/[payment_token]" \
    -H "Authorization: Bearer merchant_private_key"
Return status 200 and JSON:
Copy
...
curl "https://business.kotulapay.com/api/v1/payments/confirm" \
    -X POST \
    -H "Authorization: Bearer merchant_private_key" \
    -H "Content-Type: application/json" -d '{
        "token" : "Your Product"
...
curl "https://business.kotulapay.com/api/v1/payments/decline" \
    -X POST \
    -H "Authorization: Bearer merchant_private_key" \
    -H "Content-Type: application/json" -d '{
        "token" : "Your Product"
...
curl "https://business.kotulapay.com/api/v1/payments/order/[order_number]" \
    -H "Authorization: Bearer merchant_private_key"
Return status 200 and JSON:
Copy
...
curl "https://business.kotulapay.com/api/v1/otp" \
    -X POST \
    -H "Authorization: Bearer merchant_private_key" \
    -H "Content-Type: application/json" -d '{
...
curl "https://business.kotulapay.com/api/v1/otp-resend?token=YP741BPPRuDYSAPJG6ErFyoofWYReZWA" \
    -H "Authorization: Bearer merchant_private_key"
Return status 200 and JSON:
Copy
...
curl "https://business.kotulapay.com/api/v1/refunds" \
    -X POST \
    -H "Authorization: Bearer merchant_private_key" \
    -H "Content-Type: application/json" -d '{
        "token" : "Your Product",
...
curl "https://business.kotulapay.com/api/v1/payouts" \
    -X POST \
    -H "Authorization: Bearer merchant_private_key" \
    -H "Content-Type: application/json" -d '{
        "amount" : 1000,
...
curl "https://business.kotulapay.com/api/v1/balance?currency=CNY" \
    -X GET \
    -H "Authorization: Bearer merchant_private_key" \
...
curl "https://business.kotulapay.com/api/v1/disputes" \
    -X GET \
    -H "Authorization: Bearer merchant_private_key" \
    -H "Content-Type: application/json"
Return status 200 and JSON:
